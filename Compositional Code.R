...
##########################################################
# First step, the model estimation with ilr transformation
##########################################################
...
obsData <- data.ilr
#If a formative measurement approach is being utilized, please change from Mode A to Mode B.
mm_model <- constructs(
...
#If a formative measurement approach is being utilized, please change from reflective to formative.
...
#####################################
#Second step, measurement model evaluation
#####################################
source("evaluation.R")
...
dd1 = data.frame()
## Each composition includes two columns of data, and after ilr, there should be three components
for (i in 1:11){
...
#Cronbach’s alpha and composite reliablity
...
#####################################
#Fourth step, predictive power evaluation
#####################################
# Scores
